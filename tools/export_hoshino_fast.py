...
def download_hoshino_fast():
    urls = [
        "https://hf-mirror.com/LordDavis778/BlueArchivevoicemodels/resolve/main/TakanashiHoshino.zip",
        "https://huggingface.co/LordDavis778/BlueArchivevoicemodels/resolve/main/TakanashiHoshino.zip",
    ]
    zip_path = r"E:\大肥鱼\site\tools\TakanashiHoshino.zip"
        ...
        for url in urls:
            try:
                ...
                if r.ok:
                    ...
                    print(f"File size: {tot/1024/1024:.2f} MB")
                    with open(zip_path, 'wb') as f:
                        ...
                        for chunk in r.iter_content(chunk_size=1024*1024):
                            if chunk:
                                ...
                                dl += len(chunk)
                                if tot:
                                    print(f"Downloaded {dl/1024/1024:.1f}/{tot/1024/1024:.1f} MB ({dl*100/tot:.1f}%)")
    ...
    if not os.path.exists(zip_path) or os.path.getsize(zip_path) < 100000:
        print("Failed to download zip from all sources!")
        return False
